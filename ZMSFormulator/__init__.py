class ZMSFormulator:
	...
	# Attrs
	class Attrs:
		icon_clazz = {"custom":"icon-list-alt"
			,"default":""
			,"id":"icon_clazz"
			,"keys":[]
			,"mandatory":0
		...
		attr_dc_accessrights_restricted = {"default":"0"
			...
			,"name":"Zugriffsschutz"
			,"repetitive":0
			,"type":"attr_dc_accessrights_restricted"}

		attr_dc_relation_backlink = {"default":""
			,"id":"attr_dc_relation_backlink"
			,"keys":[]
			,"mandatory":0
			,"multilang":1
			,"name":"Force Backlink"
		...
		attr_dc_identifier_url_node = {"default":""
			,"id":"attr_dc_identifier_url_node"
			,"keys":[]
			,"mandatory":0
			,"multilang":1
			,"name":"URL Pfadname"
			,"repetitive":0
			,"type":"attr_dc_identifier_url_node"}
